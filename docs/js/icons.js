/**
 * PPPLUSH — Inline SVG icon library (Lucide-style, 24×24, stroke-based).
 * Usage: icon('home', { class: 'icon-sm' })
 */
(function () {
  'use strict';
  ...
  const PATHS = {
    ...
    'flask': '<path d="M9 2v6.5L4.7 17.3A1 1 0 0 0 5.6 18.7h12.8a1 1 0 0 0 .9-1.4L15 8.5V2"/><path d="M8 2h8M9 14h6"/>',
  ...
  window.icon = function (name, opts) {
    ...
    return '<svg class="' + cls + '" xmlns="http://www.w3.org/2000/svg" width="' + size + '" height="' + size + '" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">' + path + '</svg>';
  };
})();
